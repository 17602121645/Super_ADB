...
# -*- coding: utf-8 -*-
"""
wifi_pwd_cracker.py — WiFi 密码审计工具（多进程 + 多线程混合并行）
=================================================================
...
def main():
    ...
    if not getattr(args, 'cmd', None):
        ...
        parser.print_help()
        print('\n快速上手：')
        print('  wifi_pwd_cracker.py recover                # 找回本机已保存的 WiFi 密码')
        print('  wifi_pwd_cracker.py gen 8 -o digits.txt    # 生成 8 位纯数字字典')
        print('  wifi_pwd_cracker.py crack --help           # 查看 PMKID 破解详细用法')
        print('  wifi_pwd_cracker.py gen 4 -o d.txt --start 0 --end 99  # 自定义范围')
        sys.exit(0)

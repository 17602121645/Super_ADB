...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logViewer_regexLbl = QLabel(self.layoutWidget11)
        self.logViewer_regexLbl.setObjectName(u"logViewer_regexLbl")

        self.logFilterBar.addWidget(self.logViewer_regexLbl)
        ...
        self.logViewer_followLbl = QLabel(self.layoutWidget11)
        self.logViewer_followLbl.setObjectName(u"logViewer_followLbl")

        self.logViewerBot.addWidget(self.logViewer_followLbl)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.logViewer_regexLbl.setText(QCoreApplication.translate("MainWindow", u"\u6b63\u5219", None))
#if QT_CONFIG(tooltip)
        self.logViewer_regexChk.setToolTip(QCoreApplication.translate("MainWindow", u"\u52fe\u9009\u540e\"\u6d88\u606f\"\u8fc7\u6ee4\u6846\u6309\u6b63\u5219\u8868\u8fbe\u5f0f\u5339\u914d\uff08re.search\uff09", None))
#endif // QT_CONFIG(tooltip)
        self.logViewer_regexChk.setText("")
        self.logViewer_btnReset.setText(QCoreApplication.translate("MainWindow", u"\u91cd\u7f6e", None))
        self.logViewer_followLbl.setText(QCoreApplication.translate("MainWindow", u"\u8ddf\u968f\u6eda\u52a8", None))
        self.logViewer_followChk.setText("")

...
HERE = Path(__file__).resolve().parent          # .../Super_ADB_Main/scripts
...
LABEL = {
    ...
    "pages": "pages/ 嵌入页面",
    "monitors": "monitors/ 性能监控",
    "utils": "utils/ 工具/纯逻辑",
    "scripts": "scripts/ 测试脚本",
}
COLOR = {
    "root": "#FFF2CC", "dialogs": "#E2EFDA", "pages": "#DEEBF7",
    "monitors": "#FCE4D6", "utils": "#EDEDED", "scripts": "#F2F2F2",
}
...
def build_dot(mods, order, edges) -> "tuple[int, int]":
    ...
    for gname in ["root", "dialogs", "pages", "monitors", "utils", "scripts"]:

...
class 安装解包对话框(对话框基类):
    ...
    def _find_jadx() -> str | None:
        ...
        if sys.platform == 'darwin':
            candidates = [
                '/opt/homebrew/bin/jadx',           # Apple Silicon (Homebrew)
                '/usr/local/bin/jadx',              # Intel Mac (Homebrew)
                '/Applications/jadx/bin/jadx',
                os.path.expanduser('~/Applications/jadx/bin/jadx'),
